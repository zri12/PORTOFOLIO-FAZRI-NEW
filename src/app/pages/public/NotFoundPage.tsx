  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-[var(--color-bg-primary)] p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center flex flex-col items-center">
        ...
        <h2 className="text-2xl lg:text-3xl font-manrope font-bold text-[var(--color-text-secondary)] mb-6">{t("Page Not Found")}</h2>
        <p className="text-[var(--color-text-muted)] max-w-md mb-10 leading-relaxed">
          {t("The page you are looking for doesn't exist or has been moved. Check the URL or return to the homepage.")}
        </p>
